          ...
          >
            <ScrollView>
              ...
              >
                ...
                />
                <View>
                  <AntDesign name="heart" size={} color={color} />
                  <AntDesign name="hearto" size{} color={color} />
                  <Ionicons name="cart-sharp" size={} color={color} />
                  <Ionicons name="cart-outline" size={} color={color} />
                </View>
                <Text
                  numberOfLines={2}
                  style={{
