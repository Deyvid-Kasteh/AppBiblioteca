          ...
          >
            <ScrollView>
              ...
              >
                ...
                />
                <View>
                  <AntDesign name="heart" size={15} color={color} />
                  <AntDesign name="hearto" size={15} color={color} />
                  <Ionicons name="cart-sharp" size={15} color={color} />
                  <Ionicons name="cart-outline" size={15} color={color} />
                </View>
                <Text
                  numberOfLines={2}
                  style={{
