      ...
      try {
        ...
        if (responseSignInMongoDb !== null) {
          try {
            ...
            const responsePicUpdate = await api.get(`/Perfil/${responseCreateSession.data.user.id}``)

              console.error(responsePicUpdate.data);

            // console.log("Começou STOREDATA");
            // const jsonValue = JSON.stringify(responsePicUpdate.data);
            // console.log(jsonValue);
            // await AsyncStorage.setItem("@user", jsonValue);
            ...
            //   "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
            // );
            // console.log(responsePicUpdate.data.user.details);
