...
export default function TopTabRoutes() {
  ...
  useEffect(() => {
    ...
    fetch(
      ...
      .then((resp) => resp.json())
      .then((data) => resultadosLivrosFantasia(data.items))
  ...
  return (
    ...
    >
      <TopTab.Screen
        ...
        initialParams={{ resultadosLivrosBestSellers }}
      />
      <TopTab.Screen
        name="Fantasia"
        component={Fantasia}
        initialParams={{ resultadosLivrosFantasia }}
      />
      <TopTab.Screen
        name="Ficção"
        component={Ficcao}
        initialParams={{ resultadosLivrosFiccao }}
      />
      <TopTab.Screen
        name="Romance"
        component={Romance}
        initialParams={{ resultadosLivrosRomance }}
      />
    </TopTab.Navigator>
  );
}
