  ...
  return (
    ...
    >
      <TopTab.Screen
        ...
        resultadosLivrosBestSellers={resultadosLivrosBestSellers}
      />
      <TopTab.Screen
        name="Fantasia"
        component={Fantasia}
        resultadosLivrosFantasia={resultadosLivrosFantasia}
      />
      <TopTab.Screen
        name="Ficção"
        component={Ficcao}
        resultadosLivrosFiccao={resultadosLivrosFiccao}
      />
      <TopTab.Screen
        name="Romance"
        component={Romance}
        resultadosLivrosRomance={resultadosLivrosRomance}
      />
    </TopTab.Navigator>
  );
}
